		...
		<div class="updraft_advert_content_right">
			...
			<?php if (!empty($button_link)) { ?>
				<div class="updraft_advert_button_container">
					<a class="button button-primary" href="<?php esc_attr(apply_filters('updraftplus_com_link', $button_link));?>" target="_blank" onclick="jQuery('.updraft-ad-container').slideUp(); jQuery.post(ajaxurl, {action: 'updraft_ajax', subaction: '<?php echo $dismiss_time;?>', nonce: '<?php echo wp_create_nonce('updraftplus-credentialtest-nonce');?>', dismiss_forever: '1' });">
	...
	<div class="updraft_notice_container">
		...
		<div class="updraft_advert_content_right">
			...
			<p>
				...
				?>
				<a class="updraft_notice_link" href="<?php esc_attr(apply_filters('updraftplus_com_link', $button_link));?>"><?php
